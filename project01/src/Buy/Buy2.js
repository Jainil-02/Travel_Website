...
import buyPhoto1 from "./Rectangle 30 (3).png"
import './Buy2.css'
...
const handleClick = () => {
    ...
    document.getElementById('price').innerHTML = ("Rs.",80*Ad + 40*Ch);
};
                    ...
                    <div className="popup1">
                        <div className="popup-content1">
                            ...
                            <div className="theMain">
                                <div className="main">
                                    <div className="Div1">
                                        <img src={buyPhoto1} alt=".."></img><br></br><br></br>
                                    ...
                                    <div className="main2">
                                        <div>
                                            ...
                                            <h4 className="py-2">Celestial Escapades & Night Sky Tour</h4>
