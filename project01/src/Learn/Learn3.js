import LearnPhoto4 from "./Rectangle 13 (8).png"
// import LearnPhoto4 from "./Rectangle 13 (8).png"
import "./Learn1.css"
...
function Learn3() {
    return (
        ...
        <div className="First">
            <div className="One">
                <div>
                    <h1 className="py-5">Sam and Pluto</h1>
                    ...
                    <img src={LearnPhoto4} alt="..." className="Learn3Ph"></img>
                ...
                <div className="Two">
                    ...
                    <img src={LearnPhoto4} alt="..." className="Learn3p"></img>
                    <img src={LearnPhoto4} alt="..." className="Learn3p"></img>
                    </div>
