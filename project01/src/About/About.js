...
function About(){
    return(
        ...
        <div className='About'>
            ...
            <div>
                <p className='container para'> Star Safari, our mission is to make the wonders of the night sky accessible to everyone. Located in one of the best stargazing spots in New Zealand, we offer a range of unforgettable experiences.</p>
            </div>
